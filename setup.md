...
If not, recommend to set the variables
then install ops with:
...
8. if it is nt there, install opencode in ~/.opencode/bin with `curl -fsSL https://opencode.ai/install | bash`
