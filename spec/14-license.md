...
is produced by `trulicense keygen` from the `MasterKey Trustable` item in the
...
```
Trustable License: a@b.c        first issue
Trustable License: a@b.c 2      second
Trustable License: a@b.c 3      third
```
